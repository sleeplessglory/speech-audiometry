...
def search(video_name, keywords): 
    ...
    if video_name and keywords: 
        ...
        print("List of videos by names and keywords:", videos, "\n")

    else: 
        if video_name: 
            videos = [f for f in os.listdir('./videos') if video_name in f.lower()] 
            print("List of videos by names:", videos, "\n")
...
def test_name():
    ...
    for i in range(len(examples)):
        ...
        print("Test for video name: ", video_name)
...
def test_name_keywords():
    ...
    for i in range(len(examples)):
        video_name=examples[i]
        keywords=examples[i]
        print("Test for video name:", video_name, "and keywords:", keywords)
        search(video_name, keywords)
test_name()
#test_keywords()
test_name_keywords()
